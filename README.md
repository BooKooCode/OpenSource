...
Open protocols and development resources for BOOKOO coffee equipment. This
repository currently contains Bluetooth Low Energy (BLE) protocol
documentation and an example SDK for integrating BOOKOO products with
...
For development inquiries, contact [develop@bookoocoffee.com](mailto:develop@bookoocoffee.com).
